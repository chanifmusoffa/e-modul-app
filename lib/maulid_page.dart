...
class MaulidPage extends StatefulWidget {
  const MaulidPage({super.key});

  @override
  State<MaulidPage> createState() => _MaulidPageState();
}

class _MaulidPageState extends State<MaulidPage> {
  final String sheetUrl =
      "https://docs.google.com/spreadsheets/d/e/2PACX-1vRbOrnXS1PBSSlvWPjuctPJB8ZB4FodX3MwJCpjM_QcemoheRgPZGqVP-2l1P_44sqEp0CG0hgblA6l/pub?gid=0&single=true&output=csv";
