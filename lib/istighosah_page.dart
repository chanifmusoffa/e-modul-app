...
class IstighosahPage extends StatefulWidget {
  const IstighosahPage({super.key});

  @override
  State<IstighosahPage> createState() => _IstighosahPageState();
}

class _IstighosahPageState extends State<IstighosahPage> {
  final String sheetUrl =
      "https://docs.google.com/spreadsheets/d/e/2PACX-1vQrdOGt6w02KPYFB-xwVwNduMPEvIQzGa8YvKW8KjnMRQZlpOAtfE9Jtmmf16Zs7g9lw9DcBz9Xxm3W/pub?gid=0&single=true&output=csv";
